...
INSERT INTO `VENTAS`.`Tb_Abastecimiento`(`Cod_prv`, `Cod_pro`, `Pre_Aba`)
...
INSERT INTO `VENTAS`.`Tb_Cliente`(`Cod_cli`, `Raz_soc_cli`, `Dir_cli`, `Tel_cli`, `Ruc_cli`, `Cod_dis`, `Fec_reg`, `Tip_cli`, `Contacto`)
...
INSERT INTO `VENTAS`.`Tb_Detalle_Compra`(`Num_oco`, `Cod_pro`, `Can_ped`)
...
INSERT INTO `VENTAS`.`Tb_Detalle_Factura`(`Num_fac`, `Cod_pro`, `Can_ven`, `Pre_ven`)
...
INSERT INTO `VENTAS`.`Tb_Distrito`(`Cod_dis`, `Nom_dis`, `Cod_ven`)
...
INSERT INTO `VENTAS`.`Tb_Factura`(`Num_fac`, `Fec_fac`, `Cod_cli`, `Fec_can`, `Est_fac`, `Cod_ven`)
...
INSERT INTO `VENTAS`.`Tb_Orden_Compra`(`Num_oco`, `Fec_oco`, `Cod_prv`, `Fec_ate`, `Est_oco`)
...
INSERT INTO `VENTAS`.`Tb_Producto`(`Cod_pro`, `Des_pro`, `Pre_pro`, `Stk_act`, `Stk_min`, `Lin_pro`, `Importado`)
...
INSERT INTO `VENTAS`.`Tb_Proveedor`(`Cod_prv`, `Raz_soc_prv`, `Dir_prv`, `Tel_prv`, `Cod_dis`, `Rep_ven`)
...
INSERT INTO `VENTAS`.`Tb_Vendedor`(`cod_ven`, `nom_ven`, `ape_ven`, `sue_ven`, `fec_ing`, `tip_ven`, `usu_ven`, `pas_ven`)
