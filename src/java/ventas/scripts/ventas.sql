...
DROP TABLE IF EXISTS `VENTAS`.`Tb_Abastecimiento`;
CREATE TABLE `VENTAS`.`Tb_Abastecimiento` (
...
DROP TABLE IF EXISTS `VENTAS`.`Tb_Cliente`;
CREATE TABLE `VENTAS`.`Tb_Cliente` (
...
DROP TABLE IF EXISTS `VENTAS`.`Tb_Detalle_Compra`;
CREATE TABLE `VENTAS`.`Tb_Detalle_Compra` (
...
DROP TABLE IF EXISTS `VENTAS`.`Tb_Detalle_Factura`;
CREATE TABLE `VENTAS`.`Tb_Detalle_Factura` (
...
DROP TABLE IF EXISTS `VENTAS`.`Tb_Distrito`;
CREATE TABLE `VENTAS`.`Tb_Distrito` (
...
DROP TABLE IF EXISTS `VENTAS`.`Tb_Factura`;
CREATE TABLE `VENTAS`.`Tb_Factura` (
  `Num_fac` VARCHAR(5) NOT NULL,
...
DROP TABLE IF EXISTS `VENTAS`.`Tb_Orden_Compra`;
CREATE TABLE `VENTAS`.`Tb_Orden_Compra` (
  `Num_oco` VARCHAR(5) NOT NULL,
...
DROP TABLE IF EXISTS `VENTAS`.`Tb_Producto`;
...
DROP TABLE IF EXISTS `VENTAS`.`Tb_Proveedor`;
CREATE TABLE `VENTAS`.`Tb_Proveedor` (
  `Cod_prv` VARCHAR(4) NOT NULL,
...
DROP TABLE IF EXISTS `VENTAS`.`Tb_Vendedor`;
CREATE TABLE `VENTAS`.`Tb_Vendedor` (
